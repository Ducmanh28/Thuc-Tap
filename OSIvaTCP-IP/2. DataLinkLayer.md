...
- Như ta có thể thấy ở dòng **2547**, máy cá nhân mang IP: `192.168.68.78` đã gửi 1 `ARP Request` muốn hỏi xem IP `192.168.68.1` là của thiết bị nào
    ...
    - Ô xanh dương: MAC/IP máy gửi
    - Ô xanh lá: MAC/IP máy nhận
- Và ngay sau đó, ở dòng **2548**, Thiết bị có IP `192.168.68.1` đã trả lời lại bằng 1 gói tin `ARP Reply` cho máy cá nhân.
