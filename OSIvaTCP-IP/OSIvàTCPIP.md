...
- [Tìm hiểu tổng quan về mô hình OSI và TCP/IP](#tìm-hiểu-tổng-quan-về-mô-hình-osi-và-tcpip)
    - [I. Mô hình TCP/IP](#i-mô-hình-tcpip)
        ...
        - [5. Nhươc điểm của mô hình TCP/IP](#5-nhược-điểm-của-mô-hình-tcpip)
        - [6. Những tìm hiểu thêm về mô hình TCP/IP](#6-những-tìm-hiểu-thêm-về-mô-hình-tcpip)
            - [6.1 Hai giao thức ở tầng Transport: TCP và UDP](#61-hai-giao-thức-ở-tầng-transport-tcp-và-udp)
                - [6.1.1 TCP](#611-tcptranmission-control-protocol)
                - [6.1.2 UDP](#612-udp-user-datagram-protocol)  
                - [6.1.3 So sánh 2 giao thức](#613-so-sánh-giống-và-khác-nhau-giữa-2-giao-thức)
    ...
    - [II. Mô hình OSI](#ii-mô-hình-osi)
        ...
        - [2. Tổng quan về các lớp trong mô hình OSI](#2-tổng-quan-về-các-lớp-trong-mô-hình-osi)
            - [2.1 Tầng Application](#21-tầng-aplication)
        ...
        - [3. Quá trình truyền dữ liệu của mô hình OSI](#3-quá-trình-truyền-dữ-liệu-của-cấu-trúc-osi)
        - [4. Ưu và nhược điểm của mô hình OSI](#4-ưu-điểm-và-nhược-điểm-của-mô-hình-osi)
            - [4.1 Ưu điểm](#41-ưu-điểm)
            - [4.2 Nhược điểm](#42-nhược-điểm)
            - [4.3 Lý do](#43-lý-do)
    - [III. So sánh giữa 2 mô hình OSI và TCP/IP](#iii-so-sánh-giữa-2-mô-hình-tcpip-và-osi)
        - [1. Giống nhau](#1-sự-giống-nhau)
        - [2. Khác nhau](#2-sự-khác-nhau)
    - [IV. Khi nào thì dùng TCP/IP, khi nào dùng OSI](#iv-khi-nào-thì-dùng-tcpip-khi-nào-dùng-osi)
    - [V. Cách kiểm tra máy tính của bạn đang dùng mô hình nào?](#v-cách-kiểm-tra-xem-máy-tính-của-bạn-đang-dùng-gì)
