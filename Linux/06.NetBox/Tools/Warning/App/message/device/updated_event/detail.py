from message.device.updated_event.postchange_config import postchange_config
from message.device.updated_event.prechange_config import prechange_config
